...
export const AboutUsForm = forwardRef((props, ref) => {
    ...
    <Form layout="vertical" onFinish={onFinish} form={form}>
      ...
      <Form.Item
              ...
              rules={[
                {
                  required: true,
                  message: "Please select an About Us type",
                },
              ]}
            >
              <Select
                placeholder="Please select an About Us type"
                rules={[{ required: true, message: "Please select About Us type" }]}
                style={{width:'100%'}}
                value={newsType}
