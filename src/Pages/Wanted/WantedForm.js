...
export const WantedForm = forwardRef((props, ref) => {
    ...
    <Form layout="vertical" onFinish={onFinish} form={form}>
      ...
      <Form.Item
              ...
              rules={[
                {
                  required: true,
                  message: "Please select an Wanted type",
                },
              ]}
            >
              <Select
                placeholder="Please select an Wanted type"
                rules={[{ required: true, message: "Please select Wanted type" }]}
                style={{width:'100%'}}
                value={newsType}
